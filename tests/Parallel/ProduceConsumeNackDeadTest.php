...
class ProduceConsumeNackDeadTest extends ParallelTestCase
{
    private const BUS_NAME = 'produce-consume-nack-dead-test';
    ...
    public function test(): void
    {
        ...
        $consumer3 = $this->createProcess(NackConsume::class, [self::BUS_NAME, 'group1', 'consumer3_nack', 10, 100_000, self::SUBJECT]);
        $consumer4 = $this->createProcess(Consume::class, [self::BUS_NAME, 'group1', 'consumer4', 30, 1, 10, 100_000, self::SUBJECT]);

        $this->startAll($producer, $consumer1, $consumer2, $consumer3, $consumer4);
        $this->waitAll($producer, $consumer1, $consumer2, $consumer3, $consumer4);
